(function (global, factory) {
	...
	*/
	...
	var webworkify$1 = /*#__PURE__*/Object.freeze({
		default: webworkify,
		__moduleExports: webworkify
	});
	...
	var base64decode$1 = /*#__PURE__*/Object.freeze({
		default: base64decode,
		__moduleExports: base64decode
	});
	...
	var wa_detect$1 = /*#__PURE__*/Object.freeze({
		default: wa_detect,
		__moduleExports: wa_detect
	});

	var assign = ( objectAssign$1 && objectAssign ) || objectAssign$1;

	var base64decode$2 = ( base64decode$1 && base64decode ) || base64decode$1;

	var hasWebAssembly = ( wa_detect$1 && wa_detect ) || wa_detect$1;
	...
	//
	MultiMath.prototype.__base64decode = base64decode$2;
	...
	var multimath$1 = /*#__PURE__*/Object.freeze({
		default: multimath,
		__moduleExports: multimath
	});
	...
	var mono16$1 = /*#__PURE__*/Object.freeze({
		default: mono16,
		__moduleExports: mono16
	});
	...
	var hsl_l16$1 = /*#__PURE__*/Object.freeze({
		default: hsl_l16,
		__moduleExports: hsl_l16
	});

	var glur_mono16 = ( mono16$1 && mono16 ) || mono16$1;

	var hsl_l16$2 = ( hsl_l16$1 && hsl_l16 ) || hsl_l16$1;
	...
	var unsharp_mask = function unsharp(img, width, height, amount, radius, threshold) {
	  ...
	  var lightness = hsl_l16$2(img, width, height);
	...
	var unsharp_mask$1 = /*#__PURE__*/Object.freeze({
		default: unsharp_mask,
		__moduleExports: unsharp_mask
	});
	...
	var unsharp_mask_wasm$1 = /*#__PURE__*/Object.freeze({
		default: unsharp_mask_wasm,
		__moduleExports: unsharp_mask_wasm
	});
	...
	var unsharp_mask_wasm_base64$1 = /*#__PURE__*/Object.freeze({
		default: unsharp_mask_wasm_base64,
		__moduleExports: unsharp_mask_wasm_base64
	});

	var require$$0 = ( unsharp_mask$1 && unsharp_mask ) || unsharp_mask$1;

	var require$$1$1 = ( unsharp_mask_wasm$1 && unsharp_mask_wasm ) || unsharp_mask_wasm$1;

	var require$$2 = ( unsharp_mask_wasm_base64$1 && unsharp_mask_wasm_base64 ) || unsharp_mask_wasm_base64$1;
	...
	var unsharp_mask_1 = unsharp_mask$2.name;
	var unsharp_mask_2 = unsharp_mask$2.fn;
	var unsharp_mask_3 = unsharp_mask$2.wasm_fn;
	var unsharp_mask_4 = unsharp_mask$2.wasm_src;

	var unsharp_mask$3 = /*#__PURE__*/Object.freeze({
		default: unsharp_mask$2,
		__moduleExports: unsharp_mask$2,
		name: unsharp_mask_1,
		fn: unsharp_mask_2,
		wasm_fn: unsharp_mask_3,
		wasm_src: unsharp_mask_4
	});
	...
	var resize_filter_info$1 = /*#__PURE__*/Object.freeze({
		default: resize_filter_info,
		__moduleExports: resize_filter_info
	});

	var FILTER_INFO = ( resize_filter_info$1 && resize_filter_info ) || resize_filter_info$1;
	...
	var resize_filter_gen$1 = /*#__PURE__*/Object.freeze({
		default: resize_filter_gen,
		__moduleExports: resize_filter_gen
	});
	...
	var convolve_1 = convolve.convolveHorizontally;
	var convolve_2 = convolve.convolveVertically;

	var convolve$1 = /*#__PURE__*/Object.freeze({
		default: convolve,
		__moduleExports: convolve,
		convolveHorizontally: convolve_1,
		convolveVertically: convolve_2
	});

	var createFilters = ( resize_filter_gen$1 && resize_filter_gen ) || resize_filter_gen$1;

	var require$$0$1 = ( convolve$1 && convolve ) || convolve$1;

	const convolveHorizontally$1 = require$$0$1.convolveHorizontally;
	const convolveVertically$1   = require$$0$1.convolveVertically;
	...
	var resize$1 = /*#__PURE__*/Object.freeze({
		default: resize,
		__moduleExports: resize
	});
	...
	var resize_wasm$1 = /*#__PURE__*/Object.freeze({
		default: resize_wasm,
		__moduleExports: resize_wasm
	});
	...
	var convolve_wasm_base64$1 = /*#__PURE__*/Object.freeze({
		default: convolve_wasm_base64,
		__moduleExports: convolve_wasm_base64
	});

	var require$$0$2 = ( resize$1 && resize ) || resize$1;

	var require$$1$2 = ( resize_wasm$1 && resize_wasm ) || resize_wasm$1;

	var require$$2$1 = ( convolve_wasm_base64$1 && convolve_wasm_base64 ) || convolve_wasm_base64$1;

	var mm_resize = {
	  name:     'resize',
	  fn:       require$$0$2,
	  wasm_fn:  require$$1$2,
	  wasm_src: require$$2$1
	};
	var mm_resize_1 = mm_resize.name;
	var mm_resize_2 = mm_resize.fn;
	var mm_resize_3 = mm_resize.wasm_fn;
	var mm_resize_4 = mm_resize.wasm_src;

	var mm_resize$1 = /*#__PURE__*/Object.freeze({
		default: mm_resize,
		__moduleExports: mm_resize,
		name: mm_resize_1,
		fn: mm_resize_2,
		wasm_fn: mm_resize_3,
		wasm_src: mm_resize_4
	});

	var inherits$2 = ( inherits$1 && inherits ) || inherits$1;

	var Multimath = ( multimath$1 && multimath ) || multimath$1;

	var mm_unsharp_mask = ( unsharp_mask$3 && unsharp_mask$2 ) || unsharp_mask$3;

	var mm_resize$2 = ( mm_resize$1 && mm_resize ) || mm_resize$1;
	...
	var mathlib$1 = /*#__PURE__*/Object.freeze({
		default: mathlib,
		__moduleExports: mathlib
	});
	...
	var require$$0$3 = ( mathlib$1 && mathlib ) || mathlib$1;

	var worker = function () {
	  const MathLib = require$$0$3;
	...
	var tiler$1 = /*#__PURE__*/Object.freeze({
		default: tiler,
		__moduleExports: tiler
	});

	var webworkify$2 = ( webworkify$1 && webworkify ) || webworkify$1;

	var Pool$1 = ( pool$1 && pool ) || pool$1;

	var utils$2 = ( utils$1 && utils ) || utils$1;

	var worker$2 = ( worker$1 && worker ) || worker$1;

	var createStages = ( stepper$1 && stepper ) || stepper$1;

	var createRegions = ( tiler$1 && tiler ) || tiler$1;
	...
	Pica.prototype.init = function () {
	  ...
	  this.__mathlib = new require$$0$3(features);
	    ...
	    if ((typeof window !== 'undefined') && ('Worker' in window)) {
	      ...
	      try {
	        ...
	        if (singletones[wpool_key]) {
	          ...
	          this.__workersPool = new Pool$1(workerFabric, this.options.idle);
	  ...
	  if (!CAN_CREATE_IMAGE_BITMAP) {
	    ...
	    checkCibResize = utils$2.cib_support().then(status => {
	...
	var iota$1 = /*#__PURE__*/Object.freeze({
		default: iota_1,
		__moduleExports: iota_1
	});
	...
	var iota$2 = ( iota$1 && iota_1 ) || iota$1;
...
b"+i+"*=d\
	...
	var ndarray$1 = /*#__PURE__*/Object.freeze({
		default: ndarray,
		__moduleExports: ndarray
	});
	...
	var uniq$1 = /*#__PURE__*/Object.freeze({
		default: uniq,
		__moduleExports: uniq
	});

	var uniq$2 = ( uniq$1 && uniq ) || uniq$1;
	...
	function generateCWiseOp(proc, typesig) {
	  ...
	  var thisVars = uniq$2([].concat(proc.pre.thisVars)
	...
	var compile$1 = /*#__PURE__*/Object.freeze({
		default: compile,
		__moduleExports: compile
	});

	var compile$2 = ( compile$1 && compile ) || compile$1;
	...
	function createThunk(proc) {
	  ...
	  return thunk(compile$2.bind(undefined, proc))
	}

	var thunk = createThunk;

	var thunk$1 = /*#__PURE__*/Object.freeze({
		default: thunk,
		__moduleExports: thunk
	});

	var createThunk$1 = ( thunk$1 && thunk ) || thunk$1;
	...
	var compile$3 = ( compiler$1 && compiler ) || compiler$1;
	...
	exports.norm2squared = compile$3({
	  args:["array"],
	  pre: {args:[], localVars:[], thisVars:["this_s"], body:"this_s=0"},
	...
	var ndarrayOps$1 = /*#__PURE__*/Object.freeze({
		default: ndarrayOps,
		__moduleExports: ndarrayOps,
		any: ndarrayOps_1,
		all: ndarrayOps_2,
		sum: ndarrayOps_3,
		prod: ndarrayOps_4,
		norm2squared: ndarrayOps_5,
		norm2: ndarrayOps_6,
		norminf: ndarrayOps_7,
		norm1: ndarrayOps_8,
		sup: ndarrayOps_9,
		inf: ndarrayOps_10,
		argmin: ndarrayOps_11,
		argmax: ndarrayOps_12,
		random: ndarrayOps_13,
		assign: ndarrayOps_14,
		assigns: ndarrayOps_15,
		equals: ndarrayOps_16
	});
	...
	var twiddle$1 = /*#__PURE__*/Object.freeze({
		default: twiddle,
		__moduleExports: twiddle,
		INT_BITS: INT_BITS_1,
		INT_MAX: INT_MAX,
		INT_MIN: INT_MIN,
		sign: sign,
	...
	var dup$1 = /*#__PURE__*/Object.freeze({
		default: dup,
		__moduleExports: dup
	});

	var bits = ( twiddle$1 && twiddle ) || twiddle$1;

	var dup$2 = ( dup$1 && dup ) || dup$1;
	...
	//Upgrade pool
	if(!POOL.UINT8C) {
	  POOL.UINT8C = dup$2([32, 0]);
	}
	if(!POOL.BUFFER) {
	  POOL.BUFFER = dup$2([32, 0]);
	}
	...
	var pool$3 = /*#__PURE__*/Object.freeze({
		...
		freeFloat64: pool_10,
		freeDouble: pool_11,
		freeUint8Clamped: pool_12,
		freeDataView: pool_13,
		freeArrayBuffer: pool_14,
		freeBuffer: pool_15,
		malloc: pool_16,
		mallocArrayBuffer: pool_17,
		mallocUint8: pool_18,
		mallocUint16: pool_19,
		mallocUint32: pool_20,
		mallocInt8: pool_21,
		mallocInt16: pool_22,
		mallocInt32: pool_23,
		mallocFloat32: pool_24,
		mallocFloat: pool_25,
		mallocFloat64: pool_26,
		mallocDouble: pool_27,
		mallocUint8Clamped: pool_28,
		mallocDataView: pool_29,
		mallocBuffer: pool_30,
		clearCache: pool_31
	});

	var ndarray$2 = ( ndarray$1 && ndarray ) || ndarray$1;

	var ops = ( ndarrayOps$1 && ndarrayOps ) || ndarrayOps$1;

	var pool$4 = ( pool$3 && pool$2 ) || pool$3;
	...
	function texSubImageArray(gl, x_off, y_off, mip_level, cformat, ctype, mipLevels, array) {
	  ...
	  if(shape.length === 2) {
	    ...
	    array = ndarray$2(array.data, shape, [array.stride[0], array.stride[1], 1], array.offset);
	  ...
	  if(type === ctype && packed) {
	    ...
	    var pack_buffer;
	    if(ctype === gl.FLOAT) {
	      pack_buffer = pool$4.mallocFloat32(size);
	    } else {
	      pack_buffer = pool$4.mallocUint8(size);
	    }
	    var pack_view = ndarray$2(pack_buffer, shape, [shape[2], shape[2]*shape[0], 1]);
	    ...
	    if(ctype === gl.FLOAT) {
	      pool$4.freeFloat32(pack_buffer);
	    } else {
	      pool$4.freeUint8(pack_buffer);
	    }
	  }
	}
	...
	function createTextureArray(gl, array) {
	  ...
	  if(!packed) {
	    ...
	    buf_store = pool$4.malloc(size, dtype);
	    var buf_array = ndarray$2(buf_store, shape, stride, 0);
	...
	var GLError$1 = /*#__PURE__*/Object.freeze({
		default: GLError_1,
		__moduleExports: GLError_1
	});

	var coallesceUniforms = ( reflect$1 && reflect ) || reflect$1;

	var GLError$2 = ( GLError$1 && GLError_1 ) || GLError$1;
	    ...
	    switch(type) {
	      ...
	      default:
	        ...
	        if(0 <= vidx && vidx <= 1 && type.length === 4 + vidx) {
	          ...
	          if(d < 2 || d > 4) {
	            throw new GLError$2('', 'Invalid data type')
	          }
	          switch(type.charAt(0)) {
	            ...
	            default:
	              throw new GLError$2('', 'Unrecognized data type for vector ' + name + ': ' + type)
	          }
	        } else if(type.indexOf('mat') === 0 && type.length === 4) {
	          var d = type.charCodeAt(type.length-1) - 48;
	          if(d < 2 || d > 4) {
	            throw new GLError$2('', 'Invalid uniform dimension type for matrix ' + name + ': ' + type)
	          }
	          return 'gl.uniformMatrix' + d + 'fv(locations[' + index + '],false,obj' + path + ')'
	        } else {
	          throw new GLError$2('', 'Unknown uniform data type for ' + name + ': ' + type)
	        }
	      break
	    }
	  }
	...
	var createUniforms$1 = /*#__PURE__*/Object.freeze({
		default: createUniforms,
		__moduleExports: createUniforms
	});
	    ...
	    switch(type) {
	      ...
	      default:
	        if(type.indexOf('vec') >= 0) {
	          var d = type.charCodeAt(type.length-1) - 48;
	          if(d < 2 || d > 4) {
	            throw new GLError$2('', 'Invalid data type for attribute ' + name + ': ' + type)
	          }
	          addVectorAttribute(
	              gl
	            , wrapper
	          ...
	          throw new GLError$2('', 'Unknown data type for attribute ' + name + ': ' + type)
	        }
	      break
	    }
	  }
	...
	var createAttributes$1 = /*#__PURE__*/Object.freeze({
		default: createAttributes,
		__moduleExports: createAttributes
	});
	...
	var sprintf$1 = /*#__PURE__*/Object.freeze({
		default: sprintf,
		__moduleExports: sprintf
	});
	...
	var numbers$1 = /*#__PURE__*/Object.freeze({
		default: numbers,
		__moduleExports: numbers
	});

	var gl10 = ( numbers$1 && numbers ) || numbers$1;
	...
	var literals$1 = /*#__PURE__*/Object.freeze({
		default: literals,
		__moduleExports: literals
	});
	...
	var builtins$1 = /*#__PURE__*/Object.freeze({
		default: builtins,
		__moduleExports: builtins
	});

	var v100 = ( literals$1 && literals ) || literals$1;

	var literals300es = v100.slice().concat([
	   'layout'
	  , 'centroid'
	  , 'smooth'
	  , 'case'
	...
	var literals300es$1 = /*#__PURE__*/Object.freeze({
		default: literals300es,
		__moduleExports: literals300es
	});

	var require$$0$4 = ( builtins$1 && builtins ) || builtins$1;

	// 300es builtins/reserved words that were previously valid in v100
	var v100$1 = require$$0$4;
	...
	var builtins300es$1 = /*#__PURE__*/Object.freeze({
		default: builtins300es,
		__moduleExports: builtins300es
	});

	var operators$2 = ( operators$1 && operators ) || operators$1;

	var literals300es$2 = ( literals300es$1 && literals300es ) || literals300es$1;

	var builtins300es$2 = ( builtins300es$1 && builtins300es ) || builtins300es$1;
	...
	function tokenize(opt) {
	  ...
	  opt = opt || {};
	  var allBuiltins = require$$0$4;
	  var allLiterals = v100;
	  if (opt.version === '300 es') {
	    allBuiltins = builtins300es$2;
	    allLiterals = literals300es$2;
	  }
	  ...
	  function determine_operator(buf) {
	    ...
	    do {
	      idx = operators$2.indexOf(buf.slice(0, buf.length + j).join(''));
	      res = operators$2[idx];
	...
	var glslTokenizer$1 = /*#__PURE__*/Object.freeze({
		default: glslTokenizer,
		__moduleExports: glslTokenizer
	});

	var tokenize$1 = ( glslTokenizer$1 && glslTokenizer ) || glslTokenizer$1;

	var string = tokenizeString;

	function tokenizeString(str, opt) {
	  var generator = tokenize$1(opt);
	  var tokens = [];
	...
	var atobNode$1 = /*#__PURE__*/Object.freeze({
		default: atobNode,
		__moduleExports: atobNode
	});

	var tokenize$2 = ( string$1 && string ) || string$1;

	var atob$1 = ( atobNode$1 && atobNode ) || atobNode$1;
	...
	function getName(src) {
	  ...
	  for (var i = 0; i < tokens.length; i++) {
	    ...
	    return (b64 ? atob$1(name) : name).trim()
	  }
	}

	var glslShaderName$1 = /*#__PURE__*/Object.freeze({
		default: glslShaderName,
		__moduleExports: glslShaderName
	});
	...
	var padLeft = function padLeft(str, num, ch) {
	  ...
	  return repeat$1(ch, num) + str;
	};

	var padLeft$1 = /*#__PURE__*/Object.freeze({
		default: padLeft,
		__moduleExports: padLeft
	});

	var padLeft$2 = ( padLeft$1 && padLeft ) || padLeft$1;
	...
	function addLineNumbers (string, start, delim) {
	  ...
	  return lines.map(function (line, i) {
	    ...
	    var prefix = padLeft$2(c, totalDigits - digits);
	    return prefix + delim + line
	  }).join('\n')
	}

	var addLineNumbers$1 = /*#__PURE__*/Object.freeze({
		default: addLineNumbers_1,
		__moduleExports: addLineNumbers_1
	});

	var require$$0$5 = ( sprintf$1 && sprintf ) || sprintf$1;

	var glConstants = ( lookup$1 && lookup ) || lookup$1;

	var shaderName = ( glslShaderName$1 && glslShaderName ) || glslShaderName$1;

	var addLineNumbers$2 = ( addLineNumbers$1 && addLineNumbers_1 ) || addLineNumbers$1;

	var sprintf$2 = require$$0$5.sprintf;
	...
	function formatCompilerError(errLog, src, type) {
	    ...
	    var longForm = sprintf$2('Error compiling %s shader %s:\n', typeName, name);
	    var shortForm = sprintf$2("%s%s", longForm, errLog);
	    ...
	    for (var i = 0; i < errorStrings.length; i++) {
	        ...
	        if (isNaN(lineNo)) {
	            throw new Error(sprintf$2('Could not parse error: %s', errorString));
	        }
	        errors[lineNo] = errorString;
	    }

	    var lines = addLineNumbers$2(src).split('\n');
	...
	var glFormatCompilerError$1 = /*#__PURE__*/Object.freeze({
		default: glFormatCompilerError,
		__moduleExports: glFormatCompilerError
	});
	...
	var hiddenStore$1 = /*#__PURE__*/Object.freeze({
		default: hiddenStore_1,
		__moduleExports: hiddenStore_1
	});

	var hiddenStore$2 = ( hiddenStore$1 && hiddenStore_1 ) || hiddenStore$1;
	...
	function createStore() {
	    ...
	    return function (obj) {
	        ...
	        return store && store.identity === key ?
	            store : hiddenStore$2(obj, key);
	    };
	}

	var createStore$1 = /*#__PURE__*/Object.freeze({
		default: createStore_1,
		__moduleExports: createStore_1
	});

	var createStore$2 = ( createStore$1 && createStore_1 ) || createStore$1;
	...
	var weakmapShim = weakMap;

	function weakMap() {
	    var privates = createStore$2();
	...
	var weakmapShim$1 = /*#__PURE__*/Object.freeze({
		default: weakmapShim,
		__moduleExports: weakmapShim
	});

	var formatCompilerError$1 = ( glFormatCompilerError$1 && glFormatCompilerError ) || glFormatCompilerError$1;

	var require$$0$6 = ( weakmapShim$1 && weakmapShim ) || weakmapShim$1;
	...
	var weakMap$1 = typeof WeakMap === 'undefined' ? require$$0$6 : WeakMap;
	...
	function compileShader(gl, type, src) {
	  ...
	  if(!gl.getShaderParameter(shader, gl.COMPILE_STATUS)) {
	    ...
	    try {
	        var fmt = formatCompilerError$1(errLog, src, type);
	    } catch (e){
	        console.warn('Failed to format compiler error: ' + e);
	        throw new GLError$2(errLog, 'Error compiling shader:\n' + errLog)
	    }
	    throw new GLError$2(errLog, fmt.short, fmt.long)
	  }
	  return shader
	}
	...
	function linkProgram(gl, vshader, fshader, attribs, locations) {
	  ...
	  if(!gl.getProgramParameter(program, gl.LINK_STATUS)) {
	    ...
	    throw new GLError$2(errLog, 'Error linking program: ' + errLog)
	  }
	  return program
	}
	...
	var shaderCache$1 = /*#__PURE__*/Object.freeze({
		default: shaderCache,
		__moduleExports: shaderCache,
		shader: shader,
		program: program
	});
	...
	var runtimeReflect$1 = /*#__PURE__*/Object.freeze({
		default: runtimeReflect,
		__moduleExports: runtimeReflect,
		uniforms: uniforms,
		attributes: attributes
	});

	var createUniformWrapper$1 = ( createUniforms$1 && createUniforms ) || createUniforms$1;

	var createAttributeWrapper$1 = ( createAttributes$1 && createAttributes ) || createAttributes$1;

	var shaderCache$2 = ( shaderCache$1 && shaderCache ) || shaderCache$1;

	var runtime = ( runtimeReflect$1 && runtimeReflect ) || runtimeReflect$1;
	...
	proto$3.update = function(
	  ...
	  wrapper._vref = shaderCache$2.shader(gl, gl.VERTEX_SHADER, vertSource);
	  if(pvref) {
	    pvref.dispose();
	  }
	  wrapper.vertShader = wrapper._vref.shader;
	  var pfref = this._fref;
	  wrapper._fref = shaderCache$2.shader(gl, gl.FRAGMENT_SHADER, fragSource);
	  if(pfref) {
	    pfref.dispose();
	  }
	  ...
	  function relink() {
	    wrapper.program = shaderCache$2.program(
	        gl
	      , wrapper._vref
	      , wrapper._fref
	      , attributeNames
	  ...
	  //Generate type info
	  wrapper.types = {
	    uniforms:   coallesceUniforms(uniforms),
	    attributes: coallesceUniforms(attributes)
	  };

	  //Generate attribute wrappers
	  wrapper.attributes = createAttributeWrapper$1(
	      gl
	    , wrapper
	    , attributeUnpacked
	    , attributeLocations);
	  ...
	  Object.defineProperty(wrapper, 'uniforms', createUniformWrapper$1(
	      gl
	    , wrapper
	    , uniforms
	    , uniformLocations));
	...
	var glShader$1 = /*#__PURE__*/Object.freeze({
		default: glShader,
		__moduleExports: glShader
	});

	var createShader$1 = ( glShader$1 && glShader ) || glShader$1;
	...
	function GlslTransition (gl, fragmentShader) {
	  ...
	  this.gl = gl;
	  this.shader = createShader$1(gl, vertexShader, fragmentShader);
	...
	var backInOut$1 = /*#__PURE__*/Object.freeze({
		default: backInOut_1,
		__moduleExports: backInOut_1
	});
	...
	var backIn$1 = /*#__PURE__*/Object.freeze({
		default: backIn_1,
		__moduleExports: backIn_1
	});
	...
	var backOut$1 = /*#__PURE__*/Object.freeze({
		default: backOut_1,
		__moduleExports: backOut_1
	});
	...
	var bounceOut$1 = /*#__PURE__*/Object.freeze({
		default: bounceOut_1,
		__moduleExports: bounceOut_1
	});

	var bounceOut$2 = ( bounceOut$1 && bounceOut_1 ) || bounceOut$1;

	function bounceInOut(t) {
	  return t < 0.5
	    ? 0.5 * (1.0 - bounceOut$2(1.0 - t * 2.0))
	    : 0.5 * bounceOut$2(t * 2.0 - 1.0) + 0.5
	}

	var bounceInOut_1 = bounceInOut;

	var bounceInOut$1 = /*#__PURE__*/Object.freeze({
		default: bounceInOut_1,
		__moduleExports: bounceInOut_1
	});

	function bounceIn(t) {
	  return 1.0 - bounceOut$2(1.0 - t)
	}

	var bounceIn_1 = bounceIn;

	var bounceIn$1 = /*#__PURE__*/Object.freeze({
		default: bounceIn_1,
		__moduleExports: bounceIn_1
	});
	...
	var circInOut$1 = /*#__PURE__*/Object.freeze({
		default: circInOut_1,
		__moduleExports: circInOut_1
	});
	...
	var circIn$1 = /*#__PURE__*/Object.freeze({
		default: circIn_1,
		__moduleExports: circIn_1
	});
	...
	var circOut$1 = /*#__PURE__*/Object.freeze({
		default: circOut_1,
		__moduleExports: circOut_1
	});
	...
	var cubicInOut$1 = /*#__PURE__*/Object.freeze({
		default: cubicInOut_1,
		__moduleExports: cubicInOut_1
	});
	...
	var cubicIn$1 = /*#__PURE__*/Object.freeze({
		default: cubicIn_1,
		__moduleExports: cubicIn_1
	});
	...
	var cubicOut$1 = /*#__PURE__*/Object.freeze({
		default: cubicOut_1,
		__moduleExports: cubicOut_1
	});
	...
	var elasticInOut$1 = /*#__PURE__*/Object.freeze({
		default: elasticInOut_1,
		__moduleExports: elasticInOut_1
	});
	...
	var elasticIn$1 = /*#__PURE__*/Object.freeze({
		default: elasticIn_1,
		__moduleExports: elasticIn_1
	});
	...
	var elasticOut$1 = /*#__PURE__*/Object.freeze({
		default: elasticOut_1,
		__moduleExports: elasticOut_1
	});
	...
	var expoInOut$1 = /*#__PURE__*/Object.freeze({
		default: expoInOut_1,
		__moduleExports: expoInOut_1
	});
	...
	var expoIn$1 = /*#__PURE__*/Object.freeze({
		default: expoIn_1,
		__moduleExports: expoIn_1
	});
	...
	var expoOut$1 = /*#__PURE__*/Object.freeze({
		default: expoOut_1,
		__moduleExports: expoOut_1
	});
	...
	var quadInOut$1 = /*#__PURE__*/Object.freeze({
		default: quadInOut_1,
		__moduleExports: quadInOut_1
	});
	...
	var quadIn$1 = /*#__PURE__*/Object.freeze({
		default: quadIn_1,
		__moduleExports: quadIn_1
	});
	...
	var quadOut$1 = /*#__PURE__*/Object.freeze({
		default: quadOut_1,
		__moduleExports: quadOut_1
	});
	...
	var quartInOut$1 = /*#__PURE__*/Object.freeze({
		default: quartInOut,
		__moduleExports: quartInOut
	});
	...
	var quartIn$1 = /*#__PURE__*/Object.freeze({
		default: quartIn,
		__moduleExports: quartIn
	});
	...
	var quartOut$1 = /*#__PURE__*/Object.freeze({
		default: quartOut,
		__moduleExports: quartOut
	});
	...
	var quintInOut$1 = /*#__PURE__*/Object.freeze({
		default: quintInOut,
		__moduleExports: quintInOut
	});
	...
	var quintIn$1 = /*#__PURE__*/Object.freeze({
		default: quintIn,
		__moduleExports: quintIn
	});
	...
	var quintOut$1 = /*#__PURE__*/Object.freeze({
		default: quintOut,
		__moduleExports: quintOut
	});
	...
	var sineInOut$1 = /*#__PURE__*/Object.freeze({
		default: sineInOut_1,
		__moduleExports: sineInOut_1
	});
	...
	var sineIn$1 = /*#__PURE__*/Object.freeze({
		default: sineIn_1,
		__moduleExports: sineIn_1
	});
	...
	var sineOut$1 = /*#__PURE__*/Object.freeze({
		default: sineOut_1,
		__moduleExports: sineOut_1
	});

	var require$$0$7 = ( backInOut$1 && backInOut_1 ) || backInOut$1;

	var require$$1$3 = ( backIn$1 && backIn_1 ) || backIn$1;

	var require$$2$2 = ( backOut$1 && backOut_1 ) || backOut$1;

	var require$$3 = ( bounceInOut$1 && bounceInOut_1 ) || bounceInOut$1;

	var require$$4 = ( bounceIn$1 && bounceIn_1 ) || bounceIn$1;

	var require$$6 = ( circInOut$1 && circInOut_1 ) || circInOut$1;

	var require$$7 = ( circIn$1 && circIn_1 ) || circIn$1;

	var require$$8 = ( circOut$1 && circOut_1 ) || circOut$1;

	var require$$9 = ( cubicInOut$1 && cubicInOut_1 ) || cubicInOut$1;

	var require$$10 = ( cubicIn$1 && cubicIn_1 ) || cubicIn$1;

	var require$$11 = ( cubicOut$1 && cubicOut_1 ) || cubicOut$1;

	var require$$12 = ( elasticInOut$1 && elasticInOut_1 ) || elasticInOut$1;

	var require$$13 = ( elasticIn$1 && elasticIn_1 ) || elasticIn$1;

	var require$$14 = ( elasticOut$1 && elasticOut_1 ) || elasticOut$1;

	var require$$15 = ( expoInOut$1 && expoInOut_1 ) || expoInOut$1;

	var require$$16 = ( expoIn$1 && expoIn_1 ) || expoIn$1;

	var require$$17 = ( expoOut$1 && expoOut_1 ) || expoOut$1;

	var require$$18 = ( linear$1 && linear_1 ) || linear$1;

	var require$$19 = ( quadInOut$1 && quadInOut_1 ) || quadInOut$1;

	var require$$20 = ( quadIn$1 && quadIn_1 ) || quadIn$1;

	var require$$21 = ( quadOut$1 && quadOut_1 ) || quadOut$1;

	var require$$22 = ( quartInOut$1 && quartInOut ) || quartInOut$1;

	var require$$23 = ( quartIn$1 && quartIn ) || quartIn$1;

	var require$$24 = ( quartOut$1 && quartOut ) || quartOut$1;

	var require$$25 = ( quintInOut$1 && quintInOut ) || quintInOut$1;

	var require$$26 = ( quintIn$1 && quintIn ) || quintIn$1;

	var require$$27 = ( quintOut$1 && quintOut ) || quintOut$1;

	var require$$28 = ( sineInOut$1 && sineInOut_1 ) || sineInOut$1;

	var require$$29 = ( sineIn$1 && sineIn_1 ) || sineIn$1;

	var require$$30 = ( sineOut$1 && sineOut_1 ) || sineOut$1;

	var eases = {
		'backInOut': require$$0$7,
		'backIn': require$$1$3,
		'backOut': require$$2$2,
		'bounceInOut': require$$3,
		'bounceIn': require$$4,
		'bounceOut': bounceOut$2,
		'circInOut': require$$6,
		'circIn': require$$7,
		'circOut': require$$8,
		'cubicInOut': require$$9,
		'cubicIn': require$$10,
		'cubicOut': require$$11,
		'elasticInOut': require$$12,
		'elasticIn': require$$13,
		'elasticOut': require$$14,
		'expoInOut': require$$15,
		'expoIn': require$$16,
		'expoOut': require$$17,
		'linear': require$$18,
		'quadInOut': require$$19,
		'quadIn': require$$20,
		'quadOut': require$$21,
		'quartInOut': require$$22,
		'quartIn': require$$23,
		'quartOut': require$$24,
		'quintInOut': require$$25,
		'quintIn': require$$26,
		'quintOut': require$$27,
		'sineInOut': require$$28,
		'sineIn': require$$29,
		'sineOut': require$$30
	};
	...
	var Showy = function () {
	  ...
	  _createClass(Showy, [{
	    ...
	    key: '_isType',
	    value: function _isType(object, type) {
	    ...
	    value: function _drawSlide(context, slide) {
	      ...
	      slide._hasVideo = slide.content.filter(function (object) {
	        return _this3._isType(object, 'video');
	      }).length > 0;
	    ...
	    value: function _position2Pixels(position) {
	      ...
	      position.forEach(function (val, index) {
	        ...
	        var length = [_this4._width, _this4._height, _this4._width, _this4._height][index];
	    ...
	    key: '_getImage',
	    value: function _getImage(object, callback) {
	      var _this5 = this;
	    ...
	    value: function _resizeImage(image, src, dst, callback) {
	      ...
	      pica$1.resizeBuffer({
	        ...
	        if (buffer.length) {
	          _this6._resizedImageData = new ImageData(new Uint8ClampedArray(buffer), dst.width, dst.height);

	          _this6._slideContentMap[resizedImageKey] = _this6._resizedImageData;

	          callback(_this6._slideContentMap[resizedImageKey]);
	    ...
	    key: '_drawText',
	    value: function _drawText(context, object, callback) {
	      var dst = this._position2Pixels(object.position, this._scale);

	      context.font = object.font || '72px sans-serif';
	      context.textAlign = object.align || 'center';
	      context.fillStyle = object.color || 'rgba(0, 0, 0, 1)';

	      var maxWidth = object.maxWidth ? object.maxWidth * this._width : undefined;
	    ...
	    value: function _drawImage(context, object, callback) {
	      ...
	      this._getImage(object, function (image) {
	        var src = {
	          x: 0,
	          y: 0,
	        ...
	        if (object.tile) {
	          var tile = Showy._getTile(dst, object.tile.size);

	          var _updatedCoords = Showy._updateCoords(src, tile, object.tile.scaleMode);

	          _this7._resizeImage(image, _updatedCoords.src, _updatedCoords.dst, function (resizedImageData) {

	            Showy._drawTiles(dst, _updatedCoords.dst, object.scaleMode, function (tileCoord) {
	        ...
	        var updatedCoords = Showy._updateCoords(src, dst, object.scaleMode);

	        src = updatedCoords.src;
	        dst = updatedCoords.dst;

	        _this7._resizeImage(image, src, dst, function (resizedImageData) {
	    ...
	    value: function _getVideo(object) {
	      ...
	      var url = typeof object.url === 'function' ? object.url() : object.url;
	      var sources = typeof object.sources === 'function' ? object.sources() : object.sources;

	      var videoKey = JSON.stringify(url || sources);
	      ...
	      video.addEventListener('ended', function () {
	        ...
	        _this8._videoEnded(video, object);
	      });
	    ...
	    value: function _drawVideo(context, object, callback) {
	      ...
	      this._getVideo(object, function (video) {
	        ...
	        var dst = _this9._position2Pixels(object.position, _this9._scale);

	        if (object.tile) {
	          var tile = Showy._getTile(dst, object.tile.size);

	          var _updatedCoords2 = Showy._updateCoords(src, tile, object.tile.scaleMode);

	          Showy._drawTiles(dst, _updatedCoords2.dst, object.scaleMode, function (tileCoord) {
	    ...
	    value: function _playSlideContent(index) {
	      ...
	      this._slides[index].content.forEach(function (object) {
	        if (_this10._isType(object, 'video')) {
	    ...
	    value: function _pauseSlideContent() {
	      ...
	      this._slides[this._currentSlideIndex].content.forEach(function (object) {
	        if (_this11._isType(object, 'video')) {
	          currentSlideVideos.push(_this11._getVideo(object));
	        }
	      });

	      this._slides.forEach(function (slide, index) {
	        if (index === _this11._currentSlideIndex) {
	          return;
	        }

	        slide.content.forEach(function (object) {
	          if (_this11._isType(object, 'video')) {
	            _this11._getVideo(object, function (video) {
